...
<p align="center">
  <img width="80%" src="./image/reactWithRedux_ver0.2(combineReduce)_minorArrangeChange.png">
  <br>mono-counter structure. react-redux applied.
</p>

<p align="center">
  <img width="80%" src="./image/reactWithRedux_ver1.0(multiCounter).png">
  <br>multi-counter structure. react-redux applied.
</p>
